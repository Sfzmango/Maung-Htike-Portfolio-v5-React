...
export default function Contacts() {
    ...
    return (
        <div className='bg-cover h-[100vh] overflow-auto sm:h-[100vh] sm:overflow-auto' style={{ backgroundImage: `url(${contactbg})` }}>
            <div className='bg-[#00000095] bg-cover h-[100vh] overflow-auto sm:h-[100vh] sm:overflow-auto '>
                <div className="container pt-24 px-6 mx-auto">

                    <section className="mb-32 text-gray-800">
                        <div className="flex justify-center">
                            <div className="text-center lg:max-w-3xl md:max-w-xl">
                                <h2 className="text-3xl font-bold mb-12 px-6 text-gray-200">Contact me</h2>
                            </div>
                        </div>
                                    ...
                                    <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                                        <div className="flex items-start">
                                            ...
                                            <div className="grow ml-6">
                                                <p className="font-bold mb-1 text-gray-200">My Contact</p>
                                                <p className="text-slate-400" href="mailto:maunghtikebusiness@gmail.com">maunghtikebusiness@gmail.com</p>
                                                <p className="text-slate-400" href="tel:+1 415-373-1317">+1 415-373-1317</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                                        <div className="flex items-start">
                                            ...
                                            <div className="grow ml-6">
                                                <p className="font-bold mb-1 text-gray-200">LinkedIn</p>
                                                <a href="https://www.linkedin.com/in/maung-htike-482b4b143/" target="_blank" rel="noreferrer"><p className="text-slate-400">https://www.linkedin.com/in/maung-htike-482b4b143/</p></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                                        <div className="flex align-start">
                                            ...
                                            <div className="grow ml-6">
                                                <p className="font-bold mb-1 text-gray-200">GitHub</p>
                                                <a href="https://github.com/Sfzmango" target="_blank" rel="noreferrer"><p className="text-slate-400">https://github.com/Sfzmango</p></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                                        <div className="flex align-start">
                                            ...
                                            <div className="grow ml-6">
                                                <p className="font-bold mb-1 text-gray-200">Medium</p>
                                                <a href="https://medium.com/@maunghtike" target="_blank" rel="noreferrer"><p className="text-slate-400">https://medium.com/@maunghtike</p></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
